...
/* Definitions for Motor1 */
osThreadId_t Motor1Handle;
const osThreadAttr_t Motor1_attributes = {
  .name = "Motor1",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for Motor2 */
osThreadId_t Motor2Handle;
const osThreadAttr_t Motor2_attributes = {
  .name = "Motor2",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
...
int main(void)
{
  ...
  /* Create the thread(s) */
  /* creation of Motor1 */
  Motor1Handle = osThreadNew(StartGripper, NULL, &Motor1_attributes);

  /* creation of Motor2 */
  Motor2Handle = osThreadNew(StartArt, NULL, &Motor2_attributes);
